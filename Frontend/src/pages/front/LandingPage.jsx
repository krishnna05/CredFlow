         ...
         <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
               {/* Card 1: Risk Engine */}
               <Card className="bg-slate-900/50 border-slate-800 p-8 hover:border-indigo-500/30 transition-all group">
                  <div className="flex items-center gap-4 mb-6">
                     ...
                     <div className="w-12 h-12 bg-indigo-500/10 rounded-xl flex items-center justify-center border border-indigo-500/20 group-hover:scale-110 transition-transform delay-75">
                        <Database className="w-6 h-6 text-indigo-400" />
                     </div>
                  </div>
                  <h3 className="text-2xl font-bold text-indigo-900 mb-3">Risk Engine</h3>
               ...
               <Card className="bg-slate-900/50 border-slate-800 p-8 hover:border-emerald-500/30 transition-all group">
                  <div className="flex items-center gap-4 mb-6">
                     ...
                     <div className="w-12 h-12 bg-amber-500/10 rounded-xl flex items-center justify-center border border-amber-500/20 group-hover:scale-110 transition-transform delay-75">
                        <Webhook className="w-6 h-6 text-amber-400" />
                     </div>
                  </div>
                  <h3 className="text-2xl font-bold text-amber-900 mb-3">Bank Integration</h3>
                  <p className="text-slate-500 text-lg leading-relaxed">
